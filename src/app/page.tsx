    ...
    <Container className="flex flex-col justify-between">
      <div>
        ...
        <div className="pt-16 flex flex-col gap-4 text-grey-950">
          <p>
            We study market structure, macroeconomic cycles, and on-chain data to understand the dominant trend driving
            Bitcoin’s evolving landscape. Our approach is built on patience, conviction, and the belief that disciplined
            strategy outperforms noise and speculation.
          </p>
          <p>
            We deliver the{' '}
            <a href="https://x.com/cultusventures" target="_blank">
              <i>Weekly Bitcoin & Market Outlook</i>
            </a>{' '}
            on 𝕏, offering a concise, high-level read of market structure, sentiment, and macro conditions, translated
            into plain, strategic takeaways for long-term thinkers. Complementing this, we provide real-time insights
            through our <b>REST API (coming soon)</b>, allowing developers, analysts, and investors to integrate Bitcoin
            intelligence seamlessly into their own tools and workflows.
          </p>
          <div className="font-sans text-md pt-6 text-black">
            Curious to learn more? <a href="mailto:info@cultusventures.com">Contact Us</a>
          </div>
        </div>
      </div>
